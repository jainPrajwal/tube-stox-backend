...
router
  ...
  .delete(async (req, res) => {
    ...
    try {
      ...
      res.json({
        ...RESPONSE.INTERNAL_SERVER_ERROR,
        message: `somehting went wrong while deleting the playlist`,
        errorMessage: error.message,
      });
    }
  });
...
router
  ...
  .post(async (req, res) => {
    ...
    try {
      ...
      res.json({
        ...RESPONSE.INTERNAL_SERVER_ERROR,
        message: `somehting went wrong while fetching playlsit from DB`,
        errorMessage: error.message,
      });
    }
  })
...
router.route(`/:type/videos`).get(async (req, res) => {
  const {
    params: { type },
    user,
  } = req;
